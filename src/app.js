...
function snapshot() {
  return { app: HISTORY_APP, screen, trail, rewardOpen, mode, journey, gameRows, gameOffset, station, letterIndex,
    answered, selectedTrain, choices, hint, wrong, lastReward };
}
