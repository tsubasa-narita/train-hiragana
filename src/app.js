...
function traceCompleted() {
  ...
  traceState.completedCards ||= [];
  if (!traceState.credited) {
    traceState.credited = true;
...
function restoreHistory(state) {
  ...
  if (screen === 'trace' && traceState.rewardPending) scheduleTraceFinish();
